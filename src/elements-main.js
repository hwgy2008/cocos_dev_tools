...
ie.draw_rect = function () {
    pipeDevtool.send({id: 'ie.draw_rect', data: Array.prototype.slice.call(arguments)});
}
ie.clear_rect = function () {
    pipeDevtool.send({id: 'ie.clear_rect', data: Array.prototype.slice.call(arguments)});
}
ie.modify_node = function () {
    pipeDevtool.send({id: 'ie.modify_node', data: Array.prototype.slice.call(arguments)});
}
ie.get_node_children = function (arg, fn) {
    pipeDevtool.send({id: 'ie.get_node_children', data: [arg]}, fn);
}
